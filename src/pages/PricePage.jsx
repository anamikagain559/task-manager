...
const PricePage = () => {
  return (
    <div className="py-[90px]">
      <h3 className="text-[32px] font-semibold leading-[48px] text-center my-5">
        OUR PRICE
      </h3>
      ...
      <div className="flex justify-center items-center gap-10 mt-5">
        ...
        >
          ...
          <p className="font-normal text-gray-700 dark:text-gray-400">
            Unlock the full potential of our survey platform with our Pro
            features. For only <span className="text-2xl font-bold">$20</span>,
            gain access to advanced functionalities and enhance your survey
            experience.
          </p>
          <ul
            role="list"
            className="space-y-4 text-gray-500 dark:text-gray-400 py-6"
          >
